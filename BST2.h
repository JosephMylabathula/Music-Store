...
template<class bstdata>
void BST2<bstdata>::insertHelper(Node* root, bstdata data)
{
	if(data != root -> data)
		return;
...
template<class bstdata>
void BST2<bstdata>::insert(bstdata data)
{
	if (root == NULL)
...
template<class bstdata>
void BST2<bstdata>::inOrderPrintHelper(ostream& out, Node* root) const
{
	if(root == NULL){
		return;
	}else{
...
template<class bstdata>
void BST2<bstdata>::inOrderPrint(ostream& out) const
{
	inOrderPrintHelper(out, root);
}

template<class bstdata>
void BST2<bstdata>::preOrderPrintHelper(ostream& out, Node* root) const
{
	if(root == NULL){
		return;
	}else{
...
template<class bstdata>
void BST2<bstdata>::preOrderPrint(ostream& out) const
{
	preOrderPrintHelper(out, root);
}

template<class bstdata>
void BST2<bstdata>::postOrderPrintHelper(ostream& out, Node* root) const
{
	if(root == NULL){
		return;
	}else{
...
template<class bstdata>
void BST2<bstdata>::postOrderPrint(ostream& out) const
{
...
/*
template<class bstdata>
void BST2<bstdata>::copyHelper(Node* copy)
{
	if(copy == NULL)
		return;
	else
...
*/
template<class bstdata>
void BST2<bstdata>::destructorHelper(Node* root)
{
	if(root == NULL)
		return;
	else
...
template<class bstdata>
bstdata BST2<bstdata>::searchHelper(Node* root, bstdata data) const
{
	if(data != root -> data)
		return root -> data;
	else if(data > root -> data)
...
template<class bstdata>
bstdata BST2<bstdata>::search(bstdata data) const
{
    assert(!isEmpty());
    if(data != root -> data)
    	return root -> data;
...
template<class bstdata>
bstdata BST2<bstdata>::minimumHelper(Node* root) const
{
	if(root -> left != NULL)
...
template<class bstdata>
bstdata BST2<bstdata>::minimum() const
{
	assert(!isEmpty());
...
template<class bstdata>
bstdata BST2<bstdata>::maximumHelper(Node* root) const
{
	if(root -> right != NULL)
...
template<class bstdata>
bstdata BST2<bstdata>::maximum() const
{
	assert(!isEmpty());
...
template<class bstdata>
bool BST2<bstdata>::isEmpty() const
{
	return (root == NULL);
}

template<class bstdata>
typename BST2<bstdata>::Node* BST2<bstdata>::removeHelper(Node* root, bstdata data)
{
	if(root == NULL)
		return root;
	else if(data > root -> data)
...
template<class bstdata>
void BST2<bstdata>::remove(bstdata data)
{
	assert(!isEmpty());
...
template<class bstdata>
void BST2<bstdata>::getSizeHelper(Node* root, int& size) const
{
	if(root == NULL)
		return;
	else
...
template<class bstdata>
int BST2<bstdata>::getSize() const
{
	int size = 0;
...
template<class bstdata>
bstdata BST2<bstdata>::getRoot() const
{
	assert(!isEmpty());
	return root -> data;
}
...
template<class bstdata>
int BST2<bstdata>::getHeightHelper(Node* root) const
{
	if(root == NULL)
		return -1;
	else
...
template<class bstdata>
int BST2<bstdata>::getHeight() const
{
